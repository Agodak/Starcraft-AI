...
class SparseAgent(base_agent.BaseAgent):
    ...
    def step(self, obs):
        ...
        # save the reward table for future use
        if obs.last():
            reward = obs.reward
        ...
        # recording information that helps determine the state
        ...
        # first step of the 3-step action
        ...
        # second step of the 3-step action
        ...
        # third step of the 3-step action
